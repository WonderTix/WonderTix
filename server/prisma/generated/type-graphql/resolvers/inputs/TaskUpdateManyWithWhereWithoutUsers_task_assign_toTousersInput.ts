...
@TypeGraphQL.InputType("TaskUpdateManyWithWhereWithoutUsers_task_assign_toTousersInput", {
  isAbstract: true
})
export class TaskUpdateManyWithWhereWithoutUsers_task_assign_toTousersInput {
