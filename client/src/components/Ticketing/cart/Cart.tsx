    ...
    <div className='flex flex-col items-center h-full py-[5rem] px-[1rem] tab:px-[5rem] bg-zinc-200'>
      ...
      <h1 className='flex items-center mt-2 gap-2 text-zinc-800'>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" aria-hidden="true" />
        </svg>
      ...
      <div className='flex flex-col md:flex-row gap-10 md:gap-5 mt-14 md:mt-20 items-center w-full h-full'>
        ...
        <div className='md:w-[30rem] w-full bg-zinc-900 p-9 flex flex-col items-center rounded-xl justify-between'>
          <div className='flex flex-col items-center mb-3'>
            ...
            <p className='text-amber-300 italic'>{printDiscountText(discount)}</p>
          ...
          <div className='flex flex-col items-center gap-3'>
            ...
            <button className='bg-red-600 flex items-center justify-center gap-1 w-full p-3 text-white rounded-xl disabled:opacity-50' disabled={items.length === 0} onClick={removeAllCartItems}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
              Empty Cart
            </button>
            <button className='bg-yellow-600 flex items-center justify-center gap-1 w-full p-3 text-white rounded-xl disabled:opacity-50' disabled={items.length === 0} onClick={navigateToCompleteOrder}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className={!show ? 'hidden': 'relative z-10'} aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div className="fixed z-10 inset-0 overflow-y-auto">
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 tab:p-6 tab:pb-4">
                    <div className="tab:flex tab:items-start">
                      ...
                      <div className="mt-3 text-center tab:mt-0 tab:ml-4 tab:text-left">
                        ...
                        <p className="text-sm text-gray-500 mt-2">Do you want to remove {removeContextMessage} from your cart?</p>
                      </div>
                    </div>
                  </div>
              ...
              focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500
                tab:ml-3 tab:w-auto tab:text-sm">Yes</button>
              ...
              font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2
                focus:ring-offset-2 focus:ring-indigo-500 tab:mt-0 tab:ml-3 tab:w-auto tab:text-sm">Cancel</button>
                  </div>
                </div>
              </div>
            </div>
