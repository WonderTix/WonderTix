    ...
    <div className='w-full h-screen overflow-x-hidden absolute'>
      <div className='md:ml-[18rem] md:mt-40 md:mb-[11rem] tab:mx-[5rem] mx-[1.5rem] my-[9rem]'>
        ...
        <div className="mb-7">
          ...
          <select data-testid='time-select' className="select w-full max-w-xs bg-white border border-zinc-300 rounded-lg p-3 text-zinc-600" onChange={handleTimeChange} disabled={!selectedEventId}>
