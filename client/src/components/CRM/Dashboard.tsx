    ...
    <div className='w-full h-screen   overflow-x-hidden absolute    '>
      <div className='md:ml-[22rem] md:mt-40  sm:mt-[11rem] sm:ml-[5rem] sm:mr-[5rem] sm:mb-[11rem]   '>
        ...
        <div className='grid md:grid-cols-2 sm:grid-cols-1 gap-5 '>
          ...
          <a onClick={() => navigate('/admin/contacts')} className="border-none hover:border-none hover:scale-105  transition duration-300 ease-in-out bg-gradient-to-r from-cyan-500 to-blue-500  rounded-3xl    shadow-xl   ">
            <div className="m-8 flex flex-col items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
          ...
          <a onClick={() => navigate('/admin/reporting')} className=" hover:scale-105 transition duration-300 ease-in-out   md:h-60 border-none hover:border-none bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-3xl   shadow-xl  ">
            <div className="m-8 flex flex-col items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
          ...
          <a onClick={() => navigate('/admin/tasks/create')} className="border-none hover:border-none hover:scale-105 transition duration-300 ease-in-out bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 rounded-3xl shadow-xl ">
            <div className="m-8  flex flex-col items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
          ...
          <a onClick={() => navigate('/admin/tasks/edit')} className="border-none hover:border-none hover:scale-105  h-40 transition duration-300 ease-in-out  bg-gradient-to-r from-yellow-600 to-red-600 rounded-3xl  shadow-xl  ">
          ...
          <a onClick={() => navigate('/admin/tasks/accountInformation')} className="border-none hover:border-none hover:scale-105 transition duration-300 ease-in-out  bg-gradient-to-r from-purple-400 to-yellow-400 rounded-3xl   shadow-xl  ">
            <div className="m-8 flex flex-col items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2}>
