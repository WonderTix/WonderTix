      ...
      <div className="flex flex-no-wrap">
        <div className="absolute md:relative w-[14rem] h-screen  bg-zinc-900 hidden md:block z-10">
          ...
          <ul className='space-y-7 mt-30 ml-[rem] flex flex-col items-center   '>
            ...
            <li className=" cursor-pointer mt-[12rem] text-zinc-200 font-semibold  text-md leading-3 tracking-normal  py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
              <button onClick={handleClick} className="bg-transparent border-none rounded-none transition duration-300 ease-in-out ">
                <div className="flex flex-col gap-2 items-center">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="flex flex-col justify-between h-full w-full">
              ...
              <div className="w-full">
                ...
                <div className="border-t border-gray-300">
                  <div className="w-full flex flex-col items-start justify-between px-6 pt-1">

                    <div className="flex items-center mt-2">
                      <img alt="profile-pic" src={picture} className="w-8 h-8 rounded-md" />
                      <p className="text-sm text-zinc-200 leading-4 ml-2">{name}</p>

                    </div>
                    <div className="flex items-center text-white mt-5 hover:text-indigo-700 transition duration-300  ">
            ...
            <div className="hidden md:flex w-full pr-6">
              <div className="w-1/2 h-full hidden md:flex items-center pr-24">
                <div className="relative w-full">
                  <div className=" focus:outline-none focus:border-indigo-700 w-full text-lg text-zinc-500 pl-12 py-2 font-bold ">Welcome to WonderTix CRM</div>
                </div>
              </div>
