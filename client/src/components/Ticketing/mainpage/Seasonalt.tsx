 ...
 */
const Seasonaltickets = (): ReactElement => {
  return (
    <div className='seasontickets w-full py-[5rem] md:py-[10rem] px-4 bg-zinc-200'>
      ...
      <div className='grid place-items-center mt-14'>
        <button className='px-20 py-2 bg-black border-black hover:text-black text-white border hover:bg-transparent rounded-full'>
          More Details
        </button>
      </div>
    </div>
