...
import {creditCardReconciliationController} from './controllers/creditCardReconciliationReport';
...
const createServer = async () => {
  ...
  app.use('/api/2/credit-card-reconciliation', creditCardReconciliationController)
