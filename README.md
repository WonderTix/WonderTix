...
For more details on how to use Terraform and its CLI to manage project infrastructure, see the [README.md](./terraform/README.md) in the `WonderTix/iac` directory.
