...
@TypeGraphQL.InputType('UsersCreateNestedOneWithoutTask_task_assign_toTousersInput', {
  isAbstract: true,
})
export class UsersCreateNestedOneWithoutTask_task_assign_toTousersInput {
