    ...
    >
      <div className='backdrop-blur-sm h-screen overflow-x-hidden w-full absolute bg-zinc-900/70'>
       ...
       sm:ml-[5rem] sm:mr-[5rem] sm:mb-[11rem]'
        >
          ...
          <h1 className='text-zinc-200 font-semibold text-xl mt-6'>
            Event description
          </h1>
          <div className='text-zinc-100 pr-7 mb-9'>
            {description ? description : ''}
          </div>
          <h1 className='text-zinc-200 font-semibold mb-4 text-xl mt-6'>
            Event Showings
          </h1>
          <div className='grid grid-cols-2 gap-6'>
            {tickets.map((showing) => (
              <div key={showing.event_instance_id}>
                <div
                  className='bg-zinc-900/60 text-zinc-100 p-7
                ...
                >
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex flex-row items-center gap-1'>
                      ...
                      <div className='font-semibold '>{showing.totalseats}</div>
                    </div>
                    <div className='flex flex-row items-center gap-1'>
                      <div className='text-sm text-zinc-300'>
                        Available seats:{' '}
      ...
      <div
        className={
          !show ?
            'hidden' :
            'fixed w-full h-screen overflow-x-hidden z-10 bg-gray-500 bg-opacity-75 transition-opacity'
        }
